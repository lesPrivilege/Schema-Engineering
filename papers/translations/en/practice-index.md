...
The same day's 9.5 HTML was saved as `papers/dist/schema-engineering-2026-09-07-v9.5.html`; the current dated file was updated to 9.6 in this round. The earlier Index-only entries entered the HTML with this build. Neither was pushed nor deployed.
